...
const getColumns = (showEditButton ) => [
  {
    Header: "ID",
    accessor: "id",
  },
...
function TableComponent({
  ...
  return (
    <div className="w-full min-w-[30rem] p-4 bg-black rounded-xl shadow-[0_4px_10px_rgba(0,0,0,0.03)]">
      <table {...getTableProps()}>
        <thead>
              ...
              <tr {...row.getRowProps()} className="">
                {row.cells.map((cell) => {
                  return (
                    <td
                      {...cell.getCellProps()}
                      className="p-3 text-sm font-normal text-black-700 first:rounded-l-lg last:rounded-r-lg"
                    >
                      {cell.render("Cell")}
                    </td>
                  );
